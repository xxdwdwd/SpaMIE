...
def preprocessing(adata_omics1, adata_omics2, task='Prediction', test_idx_name=None, y_pred_name=None, 
    ...
    if task =='Integration':
        if datatype == 'Stereo-CITE-seq':  
            ...
            if batch:
                sc.pp.pca(adata_omics2, use_highly_variable=False, n_comps=256)
                sc.external.pp.harmony_integrate(adata_omics2, key='batch', adjusted_basis='feat')
            else: 
                sc.pp.highly_variable_genes(adata_omics2, flavor="seurat", n_top_genes=3000)
                adata_omics2_high =  adata_omics2[:, adata_omics2.var['highly_variable']]
            ...
            if batch:
                sc.pp.pca(adata_omics1, use_highly_variable=True, n_comps=adata_omics2.n_vars-1)#32
                sc.external.pp.harmony_integrate(adata_omics1, key='batch', adjusted_basis='feat')
            else: 
                adata_omics1_high =  adata_omics1[:, adata_omics1.var['highly_variable']]
                adata_omics1.obsm['feat'] = pca(adata_omics1_high, n_comps=adata_omics2.n_vars-1)# adata_omics2.n_vars-1
            ...
            if batch:
                sc.pp.pca(adata_omics2, use_highly_variable=False, n_comps=adata_omics2.n_vars-1)
                sc.external.pp.harmony_integrate(adata_omics2, key='batch', adjusted_basis='feat')
            else: 
                sc.pp.highly_variable_genes(adata_omics2, flavor="seurat", n_top_genes=3000)
                adata_omics2_high =  adata_omics2[:, adata_omics2.var['highly_variable']]
                adata_omics2.obsm['feat'] = pca(adata_omics2_high, n_comps=adata_omics2.n_vars-1)
    ...
    feature_graph_omics1 = construct_graph_by_feature(adata_omics1)
    ...
    if task =='Integration':
        ...
        feature_graph_omics2 = construct_graph_by_feature(adata_omics2)
